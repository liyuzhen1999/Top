...
<!--          <el-radio :label="1">销售主管</el-radio>-->
...
<!--      </el-form-item>-->
    ...
    <div class="el-login-footer">
      <span>Copyright © 2022-now lyz All Rights Reserved.</span>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleLogin() {
      ...
      this.loginForm.userType=this.radio;
